...
from HeGel2.geo.map_processor_old import edge
...
class Map:
    ...
    def get_nearest_edge(self, G, point, return_geom=False, return_dist=False):
        """
        ...
        gs_edges = ox.graph_to_gdfs(G, nodes=False)["geometry"]
