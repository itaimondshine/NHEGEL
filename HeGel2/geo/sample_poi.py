...
from HeGel2.geo import map_structure, regions, walk
...
flags.DEFINE_string(
    "directory", None, "The directory where the map will be loaded from."
)
flags.DEFINE_string("path", None, "The path where the files will be saved to.")
...
def main(argv):
    ...
    walker.generate_and_save_routes(FLAGS.path, FLAGS.n_samples, FLAGS.n_cpu)
